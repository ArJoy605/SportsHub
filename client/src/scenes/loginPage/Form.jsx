                    ...
                    <Box
                        ...
                        {isRegister && (
                            <>
                                ...
                                <Box sx={{ gridColumn: "span 4" }}>
                                    ...
                                    <Select
                                        ...
                                        sx={{
                                            width: '100%',
                                            '& .MuiSelect-root': {
                                                color: palette.mode === 'dark' ? 'white' : 'black', // Customize text color
                                                backgroundColor: palette.background.default, // Customize background color
                                            },
                                            '& .MuiInput-underline:before': {
                                                borderBottomColor: palette.mode === 'dark' ? 'white' : 'black', // Customize underline color
                                            },
                                        }}
                                    >
                                ...
                                /> */}
                                <Box sx={{ gridColumn: "span 4" }}>
                                    <Typography sx={{ color: palette.text.primary }}>Occupation</Typography>
                                    <Select
                                        value={values.occupation}
                                        onChange={handleChange}
                                        name="occupation"
