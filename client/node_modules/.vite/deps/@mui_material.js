...
} from "./chunk-MWIDH6GB.js";
import {
  Fab_default,
  fabClasses_default,
  getFabUtilityClass
} from "./chunk-GQCWVXTU.js";
import {
  Divider_default,
...
import {
  ...
  useSnackbar,
  valueToPercent
} from "./chunk-U4ZHFDN3.js";
import {
  ListContext_default
} from "./chunk-GUPV45SE.js";
import {
  Transition_default
} from "./chunk-P4NNNAXW.js";
import {
  getOverlayAlpha_default,
  useTheme
} from "./chunk-MPNGTQDL.js";
import {
  alpha,
  createBox,
  createContainer,
  ...
  useMediaQuery,
  useRtl
} from "./chunk-47EYAJ5I.js";
import "./chunk-LRVR3WHM.js";
import "./chunk-PH4DH5KL.js";
import {
  require_react_dom
...
import {
  ...
  useId_default
} from "./chunk-3FWXMSAV.js";
import {
  init_useEventCallback,
  init_useIsFocusVisible,
  useEventCallback_default,
  useIsFocusVisible_default
} from "./chunk-DJVXEMBA.js";
import {
  init_isMuiElement,
  isMuiElement_default
} from "./chunk-LLK4HG42.js";
import {
  SvgIcon_default,
  createSvgIcon,
  debounce_default,
...
} from "./chunk-A5GXTSC4.js";
import {
  init_useEnhancedEffect,
  useEnhancedEffect_default
} from "./chunk-LFSNBOI3.js";
import {
  capitalize_default,
  init_capitalize,
  init_useForkRef as init_useForkRef2,
  useForkRef_default
} from "./chunk-IONLP2GP.js";
import {
  blue_default,
  common_default,
  createMixins,
...
import {
  ...
  init_extends,
  keyframes
} from "./chunk-NL42RDP4.js";
import "./chunk-JJ4TRCTM.js";
...
var PaginationItemPage = styled_default(ButtonBase_default, {
  ...
  [`&.${paginationItemClasses_default.selected}`]: _extends({}, ownerState.color !== "standard" && {
    color: (theme.vars || theme).palette[ownerState.color].main,
    border: `1px solid ${theme.vars ? `rgba(${theme.vars.palette[ownerState.color].mainChannel} / 0.5)` : (0, import_colorManipulator12.alpha)(theme.palette[ownerState.color].main, 0.5)}`,
    backgroundColor: theme.vars ? `rgba(${theme.vars.palette[ownerState.color].mainChannel} / ${theme.vars.palette.action.activatedOpacity})` : (0, import_colorManipulator12.alpha)(theme.palette[ownerState.color].main, theme.palette.action.activatedOpacity),
    "&:hover": {
      backgroundColor: theme.vars ? `rgba(${theme.vars.palette[ownerState.color].mainChannel} / calc(${theme.vars.palette.action.activatedOpacity} + ${theme.vars.palette.action.focusOpacity}))` : (0, import_colorManipulator12.alpha)(theme.palette[ownerState.color].main, theme.palette.action.activatedOpacity + theme.palette.action.focusOpacity),
      // Reset on touch devices, it doesn't add specificity
      "@media (hover: none)": {
        backgroundColor: "transparent"
      }
...
var RadioRoot = styled_default(SwitchBase_default, {
  ...
  "&:hover": {
    backgroundColor: theme.vars ? `rgba(${ownerState.color === "default" ? theme.vars.palette.action.activeChannel : theme.vars.palette[ownerState.color].mainChannel} / ${theme.vars.palette.action.hoverOpacity})` : (0, import_colorManipulator13.alpha)(ownerState.color === "default" ? theme.palette.action.active : theme.palette[ownerState.color].main, theme.palette.action.hoverOpacity),
    // Reset on touch devices, it doesn't add specificity
    "@media (hover: none)": {
      backgroundColor: "transparent"
    }
  ...
  return {
    ...
    variants: [{
      ...
      style: _extends({}, theme.vars ? {
        ...
        backgroundColor: (0, import_colorManipulator14.lighten)(theme.palette[color].main, 0.62),
        borderColor: (0, import_colorManipulator14.lighten)(theme.palette[color].main, 0.62)
      }, theme.applyStyles("dark", {
        backgroundColor: (0, import_colorManipulator14.darken)(theme.palette[color].main, 0.5)
      }), theme.applyStyles("dark", {
        borderColor: (0, import_colorManipulator14.darken)(theme.palette[color].main, 0.5)
      })))
    }))]
  };
});
    ...
    variants: [...Object.keys(((_theme$vars5 = theme.vars) != null ? _theme$vars5 : theme).palette).filter((key) => {
      ...
      style: {
        [`&:hover, &.${sliderClasses_default.focusVisible}`]: _extends({}, theme.vars ? {
          ...
          boxShadow: `0px 0px 0px 8px ${(0, import_colorManipulator14.alpha)(theme.palette[color].main, 0.16)}`
        }, {
          "@media (hover: none)": {
            boxShadow: "none"
          }
        ...
        [`&.${sliderClasses_default.active}`]: _extends({}, theme.vars ? {
          ...
          boxShadow: `0px 0px 0px 14px ${(0, import_colorManipulator14.alpha)(theme.palette[color].main, 0.16)}`
        })
      }
    })), {
      props: {
...
var SnackbarContentRoot = styled_default(Paper_default, {
  ...
  const backgroundColor = (0, import_colorManipulator15.emphasize)(theme.palette.background.default, emphasis);
  return _extends({}, theme.typography.body2, {
